...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//There is a closure happening. when the function "myFucntion" is invoked the "internal" variable gets declared and passed to the "nestedFunction" then "nestedFunction" gets invoked inside the "myFucntion" and ac
...
function lowerCaseNames(array) {
  const changedNames = array.map(function (item) {
